 ...
 * @param   {Mixed} err - The err parameter you'd send to a callback.
 * @param   {Mixed} res - The res parameter you'd send to a callback.
 * @returns {MockApiResponder}
 */
...
MockApiResponder.prototype.argsMatch = function (req) {
  ...
  // Check are the two arguments an exact match
  return eql(args, expected);
};

},{"deep-eql":9}],4:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./MockApiInstance":2,"xtend":13}],5:[function(require,module,exports){
/*!
...
},{"./lib/eql":10}],10:[function(require,module,exports){
/*!
 * deep-eql
...
},{"buffer":5,"type-detect":11}],11:[function(require,module,exports){
module.exports = require('./lib/type');

},{"./lib/type":12}],12:[function(require,module,exports){
/*!
 * type-detect
 * Copyright(c) 2013 jake luer <jake@alogicalparadox.com>
 * MIT Licensed
